        ...
        <div class="card">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php 
                    include "koneksi.php";
                    $query_lelang = mysqli_query($conn, "SELECT * FROM tb_lelang 
                    where id_user = '".$_SESSION['id_user']."' ORDER BY id_lelang DESC");
                    $no=0;
                    ...
                    <tr>
                        ...
                        <td>
                            <ol>
                            <?php
                            $query_history = mysqli_query($conn, "SELECT * FROM history_lelang d
                                            JOIN tb_masyarakat b ON b.id_user = d.id_user WHERE
                                            id_lelang = '".$data_lelang['id_lelang']."'");
                            while($data_history = mysqli_fetch_array($query_history)){
                                echo "<li>".$data_history['username']."</li>";
                            }
                            ?>
                            </ol>
                        </td>
                        ...
                        <td>
                            ...
                            $query_history = mysqli_query($conn, "SELECT * FROM history_lelang d
                                            ...
                                            id_lelang = '".$data_lelang['id_lelang']."'");
                            while($data_history = mysqli_fetch_array($query_history)){
                                echo "<li>".$data_history['nama_barang']."</li>";
                            }
                            ?>
                            </ol>
                        </td>
                        ...
                        <td>
                            ...
                            $query_history = mysqli_query($conn, "SELECT * FROM history_lelang d
                                            ...
                                            id_lelang = '".$data_lelang['id_lelang']."'");
                            while($data_history = mysqli_fetch_array($query_history)){
                                echo "<li>".$data_history['penawaran_harga']."</li>";
                            }
                            ?>
                            </ol>
                        </td>
